	...
	<body>
		...
		<div id="show-activity" class="content scaffold-show" role="main">
			...
			<ol class="property-list activity">
				...
				<g:if test="${activityInstance?.when}">
				<li class="fieldcontain">
					<span id="when-label" class="property-label"><g:message code="activity.when.label" default="When" /></span>
					
						<span class="property-value" aria-labelledby="when-label"><g:formatDate date="${activityInstance?.when}" /></span>
					
				</li>
				</g:if>
			
				<g:if test="${activityInstance?.gpx}">
				<li class="fieldcontain">
					<span id="gpx-label" class="property-label"><g:message code="activity.gpx.label" default="Gpx" /></span>
					
						<span class="property-value" aria-labelledby="gpx-label"><g:fieldValue bean="${activityInstance}" field="gpx"/></span>
